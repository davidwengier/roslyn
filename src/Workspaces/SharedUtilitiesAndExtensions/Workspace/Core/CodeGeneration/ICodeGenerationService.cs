...
internal interface ICodeGenerationService : ILanguageService
{
    ...
    /// </summary>
    bool CanAddTo(ISymbol destination, Solution solution, CancellationToken cancellationToken, CodeGenerationKind generationKind = CodeGenerationKind.Default);

    /// <summary>
    /// <c>true</c> if destination is a location where other symbols can be added to.
    /// </summary>
    bool CanAddTo(SyntaxNode destination, Solution solution, CancellationToken cancellationToken, CodeGenerationKind generationKind = CodeGenerationKind.Default);
