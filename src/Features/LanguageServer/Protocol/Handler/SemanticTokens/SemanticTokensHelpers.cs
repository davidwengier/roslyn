...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler.SemanticTokens
{
    internal static class SemanticTokensHelpers
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var tokensData = await HandleRequestHelperAsync(supportsVisualStudioExtensions, contextDocument, spans.ToImmutable(), options, cancellationToken).ConfigureAwait(false);
        ...
        public static async Task<int[]> HandleRequestHelperAsync(bool supportsVisualStudioExtensions, Document document, ImmutableArray<LinePositionSpan> spans, ClassificationOptions options, CancellationToken cancellationToken)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return ComputeTokens(supportsVisualStudioExtensions, text.Lines, updatedClassifiedSpans, tokenTypesToIndex);
        }
