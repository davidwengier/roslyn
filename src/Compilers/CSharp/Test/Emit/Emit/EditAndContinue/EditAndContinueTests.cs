...
@"class C
{
    static string F() { return ""a""; }
        ...
        public void Delta_AssemblyDefTable()
        {
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, f0, f1, options: SemanticEditOptions.PreserveLocalVariables)));
        ...
        System.Console.WriteLine(2);
            ...
            var diffError = compilation1.EmitDifference(
                ...
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, e0, e1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            var diffGood = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, g0, g1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"class C
{
    ...
    static void G([System.ComponentModel.Description(""input"")]string input) { }
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, methodF0, methodF1, options: SemanticEditOptions.EmitAllParametersForMethodUpdate),
            ...
            var diff2 = compilation2.EmitDifference(
              diff1.NextGeneration,
              ImmutableArray.Create(
                  SemanticEdit.Create(SemanticEditKind.Update, methodG1, methodG2, options: SemanticEditOptions.EmitAllParametersForMethodUpdate)));
...
";
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, invoke0, invoke1, options: SemanticEditOptions.EmitAllParametersForMethodUpdate),
                    SemanticEdit.Create(SemanticEditKind.Update, beginInvoke0, beginInvoke1, options: SemanticEditOptions.EmitAllParametersForMethodUpdate)));
...
");
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, f0, f1, options: SemanticEditOptions.PreserveLocalVariables)));
...
class C
{
    ...
    void M()
    {
        ...
        E += null;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method0, method1, GetEquivalentNodesMap(method1, method0), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"{
  ...
  IL_001d:  ret
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method1, method2, GetEquivalentNodesMap(method2, method1), options: SemanticEditOptions.PreserveLocalVariables)));
    ...
    <method token=""0x6000003"">
      ...
      <scope startOffset=""0x0"" endOffset=""0x1e"">
        ...
        <local name=""z"" il_index=""3"" il_start=""0x0"" il_end=""0x1e"" attributes=""0"" />
            ...
            var diff3 = compilation3.EmitDifference(
                diff2.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method2, method3, GetEquivalentNodesMap(method3, method2), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"class C
{
    static void M()
    {
        ...
        var b = string.Empty;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Insert, null, m1, null, options: SemanticEditOptions.PreserveLocalVariables)));

            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, m1, m2, GetEquivalentNodesMap(m2, m1), options: SemanticEditOptions.PreserveLocalVariables)));
    ...
    static void M()
    {
        ...
        using (var x = F()) { }
            ...
            var diff1a = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method0, method1, options: SemanticEditOptions.PreserveLocalVariables)));
        ...
        System.Console.WriteLine(y);
            ...
            var diff1 = compilation1.EmitDifference(
                ...
                ImmutableArray.Create(
                    ...
                    SemanticEdit.Create(SemanticEditKind.Update, method0, method1, GetEquivalentNodesMap(method1, method0), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"{
  ...
  IL_0010:  ret
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, method1, method2, GetEquivalentNodesMap(method2, method1), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"{
  ...
  IL_0010:  ret
            ...
            var diff3 = compilation3.EmitDifference(
                diff2.NextGeneration,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, method2, method3, GetEquivalentNodesMap(method3, method2), options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, f0, f1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, f1, f2, GetSyntaxMapFromMarkers(source1, source2), options: SemanticEditOptions.PreserveLocalVariables)));
...
namespace M
{
    class B
    {
        static void M()
        {
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, m0, m1, GetEquivalentNodesMap(m1, m0), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"class C
{
    static object F()
    {
        ...
        return y;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, f0, f1, GetEquivalentNodesMap(f1, f0), options: SemanticEditOptions.PreserveLocalVariables)));
...
class B
{
    ...
    static object G()
    {
        ...
        return y.B;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method0, method1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            diff1.VerifyIL("B.G", @"
{
  ...
  IL_000f:  ret       
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method1, method2, GetSyntaxMapFromMarkers(source1, source2), options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            diff2.VerifyIL("B.G", @"
{
  ...
  IL_0020:  ret       
            ...
            var diff3 = compilation3.EmitDifference(
                diff2.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method2, method3, GetSyntaxMapFromMarkers(source2, source3), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"class C
{
    ...
    static object G()
    {
        ...
        return x;
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, g1, g2, GetEquivalentNodesMap(g2, g1), options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            var diff3 = compilation3.EmitDifference(
                diff2.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, g2, g3, GetEquivalentNodesMap(g3, g2), options: SemanticEditOptions.PreserveLocalVariables)));
...
class C
{
    static void M()
    {
        ...
        var <N:1>y = new { Ab = 5 }</N:1>;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, m0, m1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"{
  ...
  IL_0010:  ret
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, m1, m2, GetSyntaxMapFromMarkers(source1, source2), options: SemanticEditOptions.PreserveLocalVariables)));
...
";
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, f0, f1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, f1, f2, GetSyntaxMapFromMarkers(source1, source2), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"class C<T>
{
    ...
    static void M2(object o)
    {
            ...
            var diff1A = compilation1A.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method0, method1A, GetEquivalentNodesMap(method1A, method0), options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            var diff1B = compilation1B.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method0, method1B, GetEquivalentNodesMap(method1B, method0), options: SemanticEditOptions.PreserveLocalVariables)));
...
@"class C
{
    ...
    static string G()
    {
        return null;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method0F, method1F, syntaxMap: s => null, options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            var diff2F = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method1F, method2F, syntaxMap: s => null, options: SemanticEditOptions.PreserveLocalVariables)));
            ...
            var diff2G = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, method1G, method2G, syntaxMap: s => null, options: SemanticEditOptions.PreserveLocalVariables)));
        }
...
");
            ...
            var diffB2 = compilationB2.EmitDifference(
               ...
               ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, f1, f2, GetEquivalentNodesMap(f2, f1), options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, ctor0, ctor1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, ctor1, ctor2, GetSyntaxMapFromMarkers(source1, source0), options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, n0, n1, GetSyntaxMapFromMarkers(source0, source1), options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, n1, n2, GetSyntaxMapFromMarkers(source1, source0), options: SemanticEditOptions.PreserveLocalVariables)));
