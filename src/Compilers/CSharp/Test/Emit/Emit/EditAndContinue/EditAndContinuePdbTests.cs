...
"), fileName: @"C:\Enc1.cs");
            ...
            var diff1 = compilation1.EmitDifference(
                ...
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, f0, f1, syntaxMap1, options: SemanticEditOptions.PreserveLocalVariables),
                    SemanticEdit.Create(SemanticEditKind.Update, g0, g1, syntaxMap1, options: SemanticEditOptions.PreserveLocalVariables)));
...
");
            ...
            var diff2 = compilation2.EmitDifference(
                ...
                ImmutableArray.Create(
                    SemanticEdit.Create(SemanticEditKind.Update, f1, f2, syntaxMap2, options: SemanticEditOptions.PreserveLocalVariables),
                    SemanticEdit.Create(SemanticEditKind.Update, g1, g2, syntaxMap2, options: SemanticEditOptions.PreserveLocalVariables),
                    SemanticEdit.Create(SemanticEditKind.Update, a1, a2, syntaxMap2, options: SemanticEditOptions.PreserveLocalVariables),
