...
End Class", fileName:="C:\Enc1.vb")
            ...
            Dim diff1 = compilation1.EmitDifference(generation0,
                ImmutableArray.Create(New SemanticEdit(SemanticEditKind.Update, f0, f1, syntaxMap1, options:=SemanticEditOptions.PreserveLocalVariables),
                                      New SemanticEdit(SemanticEditKind.Update, g0, g1, syntaxMap1, options:=SemanticEditOptions.PreserveLocalVariables)))
    ...
    <symbols>
        ...
        <methods>
            ...
            Dim diff2 = compilation2.EmitDifference(diff1.NextGeneration,
                ImmutableArray.Create(New SemanticEdit(SemanticEditKind.Update, f1, f2, syntaxMap2, options:=SemanticEditOptions.PreserveLocalVariables),
                                      New SemanticEdit(SemanticEditKind.Update, g1, g2, syntaxMap2, options:=SemanticEditOptions.PreserveLocalVariables),
                                      New SemanticEdit(SemanticEditKind.Update, a1, a2, syntaxMap2, options:=SemanticEditOptions.PreserveLocalVariables),
